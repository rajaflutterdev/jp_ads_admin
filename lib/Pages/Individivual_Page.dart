...
class _Infividual_PageState extends State<Infividual_Page> with SingleTickerProviderStateMixin{
  ...
  usertyprfunc()async{
    ...
    for(int i=0;i<data.docs.length;i++){
      ...
      collection("Histroy").where("updatestatus",isEqualTo:"").get();
      setState((){
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      StreamBuilder(
                                        ...
                                        doc(Userdocuid).collection("Wallet_Histroy").orderBy("timestamp",descending: true).snapshots(),
                                        builder: (context, snapshot) {
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SizedBox(height:8),
                                      FutureBuilder(
                                        future: FirebaseFirestore.instance.collection("Users").doc(Userdocuid).collection("Histroy").orderBy("timestamp",descending: true).get(),
                                        builder: (context, snapshot) {
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    Applieddetailspopup(
                                                                      ...
                                                                      applieddata['Type']
                                                                          .toString(),
                                                                      applieddata['aadharpicture']
                                                                          .toString(),
                                                                      applieddata['signpicture']
                                                                          .toString(),
                                                                      applieddata['photo']
                                                                          .toString(),
                                                                      applieddata['photo2']
                                                                          .toString(),
                                                                      applieddata['aadharpicture2']
                                                                          .toString(),
                                                                    );
                                                                  },
                                                                  child: Container(
