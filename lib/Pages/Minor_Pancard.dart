...
class Minor_Pancard extends StatefulWidget {
  const Minor_Pancard({super.key});

  @override
  State<Minor_Pancard> createState() => _Minor_PancardState();
}

class _Minor_PancardState extends State<Minor_Pancard> {
                                          ...
                                          SizedBox(
                                            ...
                                            child: Center(
                                              child: Text(
                                                ...
                                                style:
                                                GoogleFonts.poppins(fontSize: 14, color: const Color(0xff245BCA)),
                                              ),
                                            ),
                                          ),
  ...
  _ViewPop(name,fathername,gender,dob,pantype,date,time,picture1,picture2,picture3,picture4,picture5,docid,updatestatus){
    double height=MediaQuery.of(context).size.height;
    double width=MediaQuery.of(context).size.width;
    if(updatestatus==""){
      setState(() {
    ...
    showDialog(context: context, builder:(context) {
      return
       StatefulBuilder(builder: (context, setState) {
         ...
         return  Padding(
           padding: const EdgeInsets.only(top: 40,bottom: 40,left: 350,right:350),
           child: Scaffold(
             key:key ,
                             ...
                             Tooltip(
                               ...
                               child: InkWell(
                                 ...
                                 child: Container(
                                     ...
                                     height: height/6.51,width: 100,child:Image.network(picture1)),
                               ),
                             ),
                             InkWell(
                             ...
                             Tooltip(
                               ...
                               child: InkWell(
                                 ...
                                 child: Container(
                                     ...
                                     height: height/6.51,width: 100,child:Image.network(picture2)),
                               ),
                             ),
                             InkWell(
                             ...
                             Tooltip(
                               ...
                               child: InkWell(
                                 ...
                                 child: Container(
                                     ...
                                     height: height/6.51,width: 100,child:Image.network(picture3)),
                               ),
                             ),
                             InkWell(
                             ...
                             Tooltip(
                               ...
                               child: InkWell(
                                 ...
                                 child: Container(
                                     ...
                                     height: height/6.51,width: 100,child:Image.network(picture4)),
                               ),
                             ),
                             InkWell(
                             ...
                             Tooltip(
                               ...
                               child: InkWell(
                                 ...
                                 child: Container(
                                     ...
                                     height: height/6.51,width: 100,child:Image.network(picture5)),
                               ),
                             ),
                             InkWell(
  ...
  statusUpdatefunctio(docid) async {
    ...
    FirebaseFirestore.instance.collection("Minor_New_applied").doc(docid).update({
      "updatestatus":selectedValue2,
      "count":false
    });
  ...
  createExcel()async{
    ...
    sheet.getRangeByName("D1").setText("Pan Type");
    sheet.getRangeByName("E1").setText("Status");
    sheet.getRangeByName("F1").setText("Aadhaar No");
    sheet.getRangeByName("G1").setText("Date Of Birth");
    sheet.getRangeByName("H1").setText("Date");
    sheet.getRangeByName("I1").setText("Time");
    ...
    var Data=await FirebaseFirestore.instance.collection("Minor_New_applied").get();

    for(int i=0;i<Data.docs.length;i++){
      sheet.getRangeByName("A${i + 2}").setText(Data.docs[i]['name'].toString());
      sheet.getRangeByName("B${i + 2}").setText(Data.docs[i]['father name'].toString());
      sheet.getRangeByName("C${i + 2}").setText(Data.docs[i]['gender'].toString());
      sheet.getRangeByName("D${i + 2}").setText(Data.docs[i]['pantype'].toString());
      sheet.getRangeByName("E${i + 2}").setText(Data.docs[i]['updatestatus'].toString());
      sheet.getRangeByName("F${i + 2}").setText(Data.docs[i]['aadhar no'].toString());
      sheet.getRangeByName("G${i + 2}").setText(Data.docs[i]['dob'].toString());
      sheet.getRangeByName("H${i + 2}").setText(Data.docs[i]['date'].toString());
      sheet.getRangeByName("I${i + 2}").setText(Data.docs[i]['time'].toString());
